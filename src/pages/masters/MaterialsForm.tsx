...
import { materialsSchema, MaterialsFormData } from "@/schemas/materialsSchema";
...
export default function MaterialsForm() {
  ...
  const onSubmit = async (data: MaterialsFormData) => {
    try {
      ...
      if (isEditing && id) {
        await updateMaterial(parseInt(id), payload);
        toast({
          title: "Success",
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:col-span-2">
                <FormTextField
                  ...
                  name="title"
                  label="Title"
                  placeholder="e.g., Steel, Aluminium"
                />
                ...
                <FormTextField
                  ...
                  name="title_ar"
                  label="Title (Arabic)"
                  placeholder="e.g., الصلب, الألومنيوم"
                />
              </div>
